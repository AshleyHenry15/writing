...
Ensure that images are legible, do your best to exclude blank space, and exclude things that are not necessary for the purpose of the image. When referencing something from the UI, use an image “callout”.  Additionally, the image should always follow the reference to the image and the result of the action should come after the image.

The image callouts, colors, styles, and examples are located here.
